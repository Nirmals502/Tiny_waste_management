...
public class completed extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public completed(ArrayList<HashMap<String, String>> ackno, ArrayList<HashMap<String, String>> ackno2,String Status) {
        JOBS_STEPS = ackno;
        LIST_JOBS = ackno2;
        Statuss = Status;
...
//                    ServiceHandler.GET, nameValuePairs);
            String jsonStr = sh.makeServiceCall_withHeader("http://112.196.3.42:8298/v1/Job/GetAllJobByDriverid/"+Driver_id+"/Completed",
                ...
                try {
                    ...
                    for (int count = 0; count < jArr.length(); count++) {
                        ...
                        try {
                            ...
                            Search_result.put("Check_fragment", "Competed");
