...
public class acknowledge_fragment extends Fragment {
    Button acknoldege;
    ...
    @SuppressLint("ValidFragment")
    public acknowledge_fragment(ArrayList<HashMap<String, String>> ackno, ArrayList<HashMap<String, String>> ackno2, String Status) {
        JOBS_STEPS = ackno;
        LIST_JOBS = ackno2;
        Statuss = Status;
...
//                    ServiceHandler.GET, nameValuePairs);
            String jsonStr = sh.makeServiceCall_withHeader("http://112.196.3.42:8298/v1/Job/GetAllJobByDriverid/" + Driver_id + "/Acknowledged",
